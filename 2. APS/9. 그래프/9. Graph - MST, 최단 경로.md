...
<img title="" src="./img/kruskal.png" alt="">

<img title="" src="./img/kruskal sudo code.png" alt="">
...
- 이 때, 최단 경로는 s에서 x까지의 최단 경로와 x에서 t까지의 최단 경로로 구성된다.
  ...
  <img title="" src="./img/dijkstra sudo code.png" alt="">

<img title="" src="./img/dijkstra.png" alt="">
